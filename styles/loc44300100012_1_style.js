...
var style_loc44300100012_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (exp_label_loc44300100012_1_eval_expression(context) !== null) {
        labelText = String(exp_label_loc44300100012_1_eval_expression(context));
    }
